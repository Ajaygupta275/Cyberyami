...
const Layout = () => {
  return (
    <>
        <footer classNameName="footer-gradient py-8 px-4">
   <div className="container">
      <div className="grid grid-cols-4 lg:grid-cols-6 gap-6">
         <div className="col-span-4 sm:col-span-2 lg:col-span-2 flex flex-col items-start">
            <a className="relative flex gap-2 mb-4" href="/"><img alt="logo" src={Logo} width="130" height="50" decoding="async" data-nimg="1" loading="lazy" class="color: transparent;"/></a>
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-between lg:items-center border-t mt-4 pt-8">
         <p className="text-xs">©2022, All Rights Reserved <span class="px-1">-</span><a class="underline" href="/">Cyberyami</a><span class="text-[#757575] mx-1.5">|</span>Wissenhive E-Learning</p>
